...
*   **Height:** Approximately **2.5 – 3 meters** directly above the waste handling/bin area.
*   **Field of View (FoV):** Top-down overhead view covering approximately **2m × 2m**.
*   **Rationale:** Minimizes physical occlusion from medical staff, protects equipment from contact contamination, ensures consistent ambient lighting conditions, and maintains a standardized perspective for high-accuracy YOLOv11 inference.

```
       [ Ceiling Mount / 2.5m - 3m Height ]
                       |
                       v  (Top-down RGB Camera)
                  .----+----.
                 /    / \    \
                /    /   \    \   (2m x 2m FoV)
               /    /     \    \
              /====/=======\====\
             [-------------------]  <-- Waste Disposal Station / Bins
```
